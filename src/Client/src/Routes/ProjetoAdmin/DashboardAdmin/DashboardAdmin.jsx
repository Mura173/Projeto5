...
const adminRecentDonations = [
  { id: 1, groupName: "Grupo 5", donorName: "Big Corp (Admin)", donationType: "Dinheiro", amount: "R$1000", date: "2025-10-28" },
  { id: 2, groupName: "Grupo 2", donorName: "Alice", donationType: "Dinheiro", amount: "R$150", date: "2025-10-22" },
  { id: 3, groupName: "Grupo 7", donorName: "Bob", donationType: "Alimento", amount: "10 kg", date: "2025-10-21" },
  { id: 4, groupName: "Grupo 5", donorName: "Local Mart (Admin)", donationType: "Alimento", amount: "200 kg", date: "2025-10-20" },
];
  ...
  return (
      <>
        ...
        <div className="admin-grid">
          ...
          <DashboardCard 
            title="Grupos Ativos" 
            value={adminKpiData.totalGroups} 
          />
          <DashboardCard 
          ...
          {groupProgressData.map(group => {
            ...
            return (
              <DashboardBarra
                key={group.id}
                title={group.name}
                label={`${formatMoney(group.current)} / ${formatMoney(group.goal)}`}
                percentage={percent}
              />
            );
          })}
