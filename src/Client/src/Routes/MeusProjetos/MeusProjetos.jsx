...
const mockProjects = [
  { id: 1, name: 'Grupo 2 - 2025', startDate: '10/03/2025', mentor: 'Fulano', donation: '20kg/R$400' },
  { id: 2, name: 'Grupo 7 - 2025', startDate: '15/04/2024', mentor: 'Ciclano', donation: '200kg/R$800' },
  { id: 3, name: 'Grupo 5 - 2025', startDate: '18/04/2024', mentor: 'Beltrano', donation: '50kg/R$250' },
];
