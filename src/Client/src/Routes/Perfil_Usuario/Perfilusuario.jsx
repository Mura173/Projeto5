        ...
        <div className="cards">
          <div className="card-body">
            ...
            <div className="email-profile">
              ...
              <a href="mailto:fulanodasilva@gmail.com">
          ...
          <div className="biografia">
            ...
            <p className="txt-biografia">
              Atualmente cursando o 2° Semestre de Administração. Participante
              do grupo: Solidariedade em ação
            </p>
          </div>
        </div>
      </div>
